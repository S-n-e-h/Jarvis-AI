...
def QueryModifier(Query):
    ...
    question_words = ["what", "who", "where", "when", "why", "which", "whose", "whom", "can you", "what's", "where's", "how's"]
...
class InitialScreen(QWidget):
    ...
    def toggle_icon(self, event=None):
        if self.toggled:
            ...
            self.load_icon(GraphicsDirectoryPath('mic_off.webp'), 60, 60)
            MicButtonClosed()
        self.toggled = not self.toggled
...
class MessageScreen(QWidget):
    def __init__(self, parent=None):
        ...
        chat_section = ChatSection()  # assuming ChatSection defined somewhere
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        title_label = QLabel(f" {str("Shark ").capitalize()}")
...
if __name__ == "__main__":
    ...
    top_bar = CustomTopBar(main_window, stacked_widget)
    ...
    main_window.setWindowTitle("Shark")
